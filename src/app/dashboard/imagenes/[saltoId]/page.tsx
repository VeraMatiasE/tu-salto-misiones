...
export default function GestionImagenesPage({ params }: { params: Promise<{ saltoId: string }> }) {
  ...
  if (loading) {
    return (
      <div className="container py-10">
        <p className="font-text text-muted-foreground">Cargando imagenes del salto...</p>
      </div>
    )
  }
  ...
  return (
    <div className="container py-10">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-1">Gestiona las imágenes de este destino</p>
      </div>

      <ImagenUpload saltoId={resolvedParams.saltoId} initialImages={saltoData} />
    </div>
  )
}
