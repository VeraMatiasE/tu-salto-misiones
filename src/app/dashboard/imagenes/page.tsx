...
export default function ImagenesAdminPage() {
  ...
  return (
    <div className="container py-10">
      <div className="mb-8">
        <h1 className="font-title text-3xl font-bold tracking-tight">Administración de Imágenes</h1>
        <p className="font-text text-muted-foreground mt-1">Gestiona las imágenes de los saltos y cascadas</p>
      </div>
