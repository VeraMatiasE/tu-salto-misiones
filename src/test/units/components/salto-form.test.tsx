...
describe('SaltoForm', () => {
  ...
  describe('Renderizado inicial', () => {
    ...
    test('renderiza el formulario con datos iniciales para edición', () => {
      ...
      expect(
        screen.getByDisplayValue('Un hermoso salto con formaciones rocosas'),
      ).toBeInTheDocument()
      expect(
    ...
    test('muestra las pestañas correctamente', () => {
      ...
      const tabInformacion = screen.getByRole('tab', {
  ...
  describe('Validación de formulario', () => {
    ...
    test('valida URL de Google Maps', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('Ingresa una URL válida de Google Maps.'),
        ).toBeInTheDocument()
      })
    })
    ...
    test('valida costo de entrada no negativo', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('El valor debe de ser mayor o igual a 0'),
        ).toBeInTheDocument()
      })
    })
  })
  ...
  describe('Interacción con pestañas', () => {
    test('cambia entre pestañas correctamente', async () => {
      ...
      fireEvent.keyDown(tabCaracteristicas, {
        key: 'Enter',
        code: 'Enter',
        charCode: 13,
        bubbles: true,
      ...
      expect(
        screen.getByLabelText('Nivel de dificultad del acceso'),
      ).toBeInTheDocument()
    })
  ...
  describe('Selección de infraestructura', () => {
    ...
    test('carga correctamente las opciones de infraestructura desde datos iniciales', async () => {
      ...
      const estacionamientoCheckbox = screen.getByRole('checkbox', {
  ...
  describe('Selector de dificultad', () => {
    test('permite seleccionar nivel de dificultad', async () => {
      ...
      const altaOption = screen.getByRole('option', {
        name: 'Alta - Requiere buena condición física',
      })
